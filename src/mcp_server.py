...
class MCPAcademicServer:
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> Dict[str, Any]:
        """
        [TASK 2.1 - COMPLETED] Thực thi Tool trên MCP Server
        Thực thi request gọi Tool theo chuẩn MCP JSON-RPC
        """
        # --------------------------------------------------------------------------
        # TASK 2.1: HÀM GỌI TOOL CHUẨN MCP JSON-RPC
...
if __name__ == "__main__":
    ...
    if sched_tool and not sched_tool.get("parameters", {}).get("properties"):
        print("⏳ [TASK 1.2]: Tool 'schedule_appointment' chưa được định nghĩa properties trong 'src/tools.py'.")
    else:
        print("✅ [TASK 1.2]: Tool 'schedule_appointment' đã có schema đầy đủ.")
    ...
    if not test_result:
        ...
        print(f"✅ [TASK 2.1]: Test dispatch tool 'academic_query' thành công:")
