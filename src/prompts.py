...
6. Không gọi lại một Tool đã trả về SUCCESS với cùng tham số.
7. Với yêu cầu nhiều bước, dùng dữ liệu trong Observation trước làm tham số cho Tool tiếp theo và chỉ trả lời khi toàn bộ mục tiêu đã hoàn tất.
"""
